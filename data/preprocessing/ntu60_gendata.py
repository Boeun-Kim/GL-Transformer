'''
ntu60_gendata.py is modified from https://github.com/kenziyuliu/MS-G3D/blob/master/data_gen/ntu_gendata.py
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='raw/nturgb+d_skeletons')
    parser.add_argument(
        '--ignored_sample_path',
        default='raw/NTU_RGBD_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../NTU-RGB-D60')
